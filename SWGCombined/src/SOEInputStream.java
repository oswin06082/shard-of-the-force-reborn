...
public class SOEInputStream extends FilterInputStream implements DataInput {
    ...
    public SOEInputStream(InputStream in) throws IOException {
    	...
    	opcode = readShort();
    	if (opcode == Constants.SOE_CHL_DATA_A || opcode == Constants.SOE_DATA_FRAG_A || opcode == Constants.SOE_ACK_A || opcode == Constants.SOE_OUT_ORDER_PKT_A) {
    		sequence = readReversedShort();
