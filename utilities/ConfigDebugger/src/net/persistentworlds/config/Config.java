...
public class Config implements Serializable {
	...
	public Config() {
		...
		setRemoteAuthorizationUsername(null);
		setRemoteAuthorizationPassword(null);
	}
	...
	public void setRemoteAuthorizationUsername(
			String sRemoteAuthorizationUsername) {
	...
	public void setRemoteAuthorizationPassword(
			String sRemoteAuthorizationPassword) {
